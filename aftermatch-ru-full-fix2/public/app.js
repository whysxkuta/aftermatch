...
(async function () {
  ...
  sbtnWrap.innerHTML = '<button class="icon-btn" id="openGlobalSearch" title="Поиск">🔎</button>';
  ...
  notifWrap.innerHTML = '<button class="icon-btn" id="notifBtn" title="Уведомления">🔔<span id="notifCount" class="notif-count" style="display:none">0</span></button><div id="notifPanel" class="notif-panel hidden"></div>';
