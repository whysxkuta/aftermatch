...
try { db.exec("ALTER TABLE servers ADD COLUMN sync_token TEXT"); } catch {}
try { db.exec("ALTER TABLE servers ADD COLUMN status TEXT NOT NULL DEFAULT 'offline'"); } catch {}
try { db.exec("ALTER TABLE servers ADD COLUMN last_ping TEXT"); } catch {}
try { db.exec("ALTER TABLE servers ADD COLUMN current_match_id TEXT"); } catch {}
try { db.exec("ALTER TABLE servers ADD COLUMN meta_json TEXT"); } catch {}
try { db.exec("ALTER TABLE servers ADD COLUMN manager_version TEXT"); } catch {}
try { db.exec("ALTER TABLE matches ADD COLUMN live_json TEXT"); } catch {}
